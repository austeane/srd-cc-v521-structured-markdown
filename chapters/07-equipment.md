...
<!-- source_txt: srd_extract/run2/pages/p089.txt -->
<!-- source_image: srd_extract/run2/images/p089.png -->
...
<!-- source_txt: srd_extract/run2/pages/p090.txt -->
<!-- source_image: srd_extract/run2/images/p090.png -->
...
<!-- source_txt: srd_extract/run2/pages/p091.txt -->
<!-- source_image: srd_extract/run2/images/p091.png -->
...
<!-- source_txt: srd_extract/run2/pages/p092.txt -->
<!-- source_image: srd_extract/run2/images/p092.png -->
...
<!-- source_txt: srd_extract/run2/pages/p093.txt -->
<!-- source_image: srd_extract/run2/images/p093.png -->
...
<!-- source_txt: srd_extract/run2/pages/p094.txt -->
<!-- source_image: srd_extract/run2/images/p094.png -->
...
<!-- source_txt: srd_extract/run2/pages/p095.txt -->
<!-- source_image: srd_extract/run2/images/p095.png -->
...
<!-- source_txt: srd_extract/run2/pages/p096.txt -->
<!-- source_image: srd_extract/run2/images/p096.png -->
...
their pouch. They spread to cover a level, 10-foot-square area within 10 feet of yourself. A creature
...
<!-- source_txt: srd_extract/run2/pages/p097.txt -->
<!-- source_image: srd_extract/run2/images/p097.png -->
...
<!-- source_txt: srd_extract/run2/pages/p098.txt -->
<!-- source_image: srd_extract/run2/images/p098.png -->
...
_**Dousing a Creature or an Object.**_ When you
...
_**Dousing a Space.**_ You can take the Utilize action to pour an Oil flask on level ground to cover a
...
<!-- source_txt: srd_extract/run2/pages/p099.txt -->
<!-- source_image: srd_extract/run2/images/p099.png -->

_**Fuel.**_ Oil serves as fuel for Lamps and Lanterns.
...
**Level 1, 50 GP)**
A _Spell Scroll_ (Cantrip) or _Spell Scroll_ (Level 1) is a
...
<!-- source_txt: srd_extract/run2/pages/p100.txt -->
<!-- source_image: srd_extract/run2/images/p100.png -->
...
<!-- source_txt: srd_extract/run2/pages/p101.txt -->
<!-- source_image: srd_extract/run2/images/p101.png -->
...
<!-- source_txt: srd_extract/run2/pages/p102.txt -->
<!-- source_image: srd_extract/run2/images/p102.png -->
...
The _Identify_ spell is the fastest way to reveal an
...
might hint that it’s a _Ring of Feather Falling_.
...
puts on a _Ring of Swimming_, the GM might say, “Your
...
more than one _Ring of Protection_ at a time.
...
<!-- source_txt: srd_extract/run2/pages/p103.txt -->
<!-- source_image: srd_extract/run2/images/p103.png -->
...
character wearing a _Boot of Striding and Springing_
on one foot and a _Boot of Elvenkind_ on the other foot
...
Kit can create a _Potion of Healing_ . Doing so requires
