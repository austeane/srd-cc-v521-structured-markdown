...
<!-- source_txt: srd_extract/run2/pages/p028.txt -->
<!-- source_image: srd_extract/run2/images/p028.png -->
...
<!-- source_txt: srd_extract/run2/pages/p029.txt -->
<!-- source_image: srd_extract/run2/images/p029.png -->
...
<!-- source_txt: srd_extract/run2/pages/p030.txt -->
<!-- source_image: srd_extract/run2/images/p030.png -->
...
<!-- source_txt: srd_extract/run2/pages/p031.txt -->
<!-- source_image: srd_extract/run2/images/p031.png -->
...
| **Skill Proficiencies** | _Choose any 3 skills_ (see “Playing the Game”) |
| **Weapon Proficiencies** | Simple weapons |
| **Tool Proficiencies** | _Choose 3 Musical Instruments_ (see “Equipment”) |
| **Armor Training** | Light armor |
| **Starting Equipment** | _Choose A or B:_ (A) Leather Armor,<br>2 Daggers, Musical Instrument of your<br>choice, Entertainer’s Pack, and 19 GP;<br>or (B) 90 GP |
#### **Becoming a Bard …**
...
<!-- source_txt: srd_extract/run2/pages/p032.txt -->
<!-- source_image: srd_extract/run2/images/p032.png -->
...
_**At Higher Levels.**_ Your Bardic Inspiration die
...
_**Cantrips.**_ You know two cantrips of your choice
from the Bard spell list. _Dancing Lights_ and _Vicious_
_Mockery_ are recommended.
...
Bard spells for you.
_**Changing Your Prepared Spells.**_ Whenever you
...
<!-- source_txt: srd_extract/run2/pages/p033.txt -->
<!-- source_image: srd_extract/run2/images/p033.png -->
...
have the _Power Word Heal_ and _Power Word Kill_
...
and each spell’s school of magic is listed. In the Special column, _C_ means the spell requires Concentration, _R_ means it’s a Ritual, and _M_ means it requires a
...
<!-- source_txt: srd_extract/run2/pages/p034.txt -->
<!-- source_image: srd_extract/run2/images/p034.png -->
...
<!-- source_txt: srd_extract/run2/pages/p035.txt -->
<!-- source_image: srd_extract/run2/images/p035.png -->
...
<!-- source_txt: srd_extract/run2/pages/p036.txt -->
<!-- source_image: srd_extract/run2/images/p036.png -->
...
_**Cantrips.**_ You know three cantrips of your choice
from the Cleric spell list. _Guidance_, _Sacred Flame_,
and _Thaumaturgy_ are recommended.
...
**Proficiency** **Channel** **Prepared**
**Bonus** **Class Features** **Divinity** **Cantrips** **Spells**
...
<!-- source_txt: srd_extract/run2/pages/p037.txt -->
<!-- source_image: srd_extract/run2/images/p037.png -->
...
Features table.
_**Spell Slots.**_ The Cleric Features table shows how
many spell slots you have to cast your level 1+
spells. You regain all expended slots when you finish a Long Rest.
_**Prepared Spells of Level 1+.**_ You prepare the list
of level 1+ spells that are available for you to cast
with this feature. To start, choose four level 1 spells
from the Cleric spell list. _Bless_, _Cure Wounds_, _Guiding_
_Bolt_, and _Shield of Faith_ are recommended.
The number of spells on your list increases as you
...
_**Spellcasting Ability.**_ Wisdom is your spellcasting
ability for your Cleric spells.
_**Spellcasting Focus.**_ You can use a Holy Symbol as
...
_**Protector.**_ Trained for battle, you gain proficiency
with Martial weapons and training with Heavy
armor.
_**Thaumaturge.**_ You know one extra cantrip from
...
_**Divine Spark.**_ As a Magic action, you point your
...
_**Turn Undead.**_ As a Magic action, you present your
...
<!-- source_txt: srd_extract/run2/pages/p038.txt -->
<!-- source_image: srd_extract/run2/images/p038.png -->
...
_**Divine Strike.**_ Once on each of your turns when
...
_**Potent Spellcasting.**_ Add your Wisdom modifier
...
more powerful.
_**Divine Strike.**_ The extra damage of your Divine
Strike increases to 2d8.
_**Potent Spellcasting.**_ When you cast a Cleric cantrip and deal damage to a creature with it, you can
...
You can call on even more powerful divine intervention. When you use your Divine Intervention feature, you can choose _Wish_ when you select a spell.
...
<!-- source_txt: srd_extract/run2/pages/p039.txt -->
<!-- source_image: srd_extract/run2/images/p039.png -->
...
<!-- source_txt: srd_extract/run2/pages/p040.txt -->
<!-- source_image: srd_extract/run2/images/p040.png -->
...
<!-- source_txt: srd_extract/run2/pages/p041.txt -->
<!-- source_image: srd_extract/run2/images/p041.png -->
...
| **Skill Proficiencies**<br>_Choose 2:_ Animal Handling,<br>Arcana, Insight, Medicine, Na-<br>ture, Perception, Religion, or<br>Survival |  |
| **Weapon Proficiencies** | Simple weapons |
...
**Starting Equipment** _Choose A or B:_ (A) Leather Armor, Shield, Sickle, Druidic Focus (Quarterstaff), Explorer’s
...
**Proficiency** **Wild** **Prepared**
**Bonus** **Class Features** **Shape** **Cantrips** **Spells**
...
<!-- source_txt: srd_extract/run2/pages/p042.txt -->
<!-- source_image: srd_extract/run2/images/p042.png -->

how you use those rules with Druid spells, which
appear on the Druid spell list later in the class’s
description.
_**Cantrips.**_ You know two cantrips of your choice
from the Druid spell list. _Druidcraft_ and _Produce_
_Flame_ are recommended.
...
Features table.
_**Spell Slots.**_ The Druid Features table shows how
many spell slots you have to cast your level 1+
spells. You regain all expended slots when you finish a Long Rest.
_**Prepared Spells of Level 1+.**_ You prepare the
list of level 1+ spells that are available for you to
cast with this feature. To start, choose four level 1
spells from the Druid spell list. _Animal Friendship_,
_Cure Wounds_, _Faerie Fire_, and _Thunderwave_ are
recommended.
The number of spells on your list increases as you
...
_**Spellcasting Focus.**_ You can use a Druidic Focus
...
you always have the _Speak with Animals_ spell
prepared.
...
You have dedicated yourself to one of the following
sacred roles of your choice.
_**Magician.**_ You know one extra cantrip from the
...
_**Warden.**_ Trained for battle, you gain proficiency
...
_**Number of Uses.**_ You can use Wild Shape twice.
...
_**Known Forms.**_ You know four Beast forms for this
...
<!-- source_txt: srd_extract/run2/pages/p043.txt -->
<!-- source_image: srd_extract/run2/images/p043.png -->

_**Rules While Shape-Shifted.**_ While in a form, you
...
_Find Familiar_ spell without Material components.
...
_**Primal Strike.**_ Once on each of your turns when
you hit a creature with an attack roll using a
...
_**Potent Spellcasting.**_ When you cast a Druid cantrip with a range of 10 feet or greater, the spell’s
range increases by 300 feet.
_**Primal Strike.**_ The extra damage of your Primal
Strike increases to 2d8.
...
_**Evergreen Wild Shape.**_ Whenever you roll Initiative and have no uses of Wild Shape left, you regain
one expended use of it.
_**Nature Magician.**_ You can convert uses of Wild
...
_**Longevity.**_ The primal magic that you wield
causes you to age more slowly. For every ten years
that pass, your body ages only one year.

## Page 44

<!-- source_txt: srd_extract/run2/pages/p044.txt -->
<!-- source_image: srd_extract/run2/images/p044.png -->
...
<!-- source_txt: srd_extract/run2/pages/p045.txt -->
<!-- source_image: srd_extract/run2/images/p045.png -->
...
<!-- source_txt: srd_extract/run2/pages/p046.txt -->
<!-- source_image: srd_extract/run2/images/p046.png -->
...
<!-- source_txt: srd_extract/run2/pages/p047.txt -->
<!-- source_image: srd_extract/run2/images/p047.png -->
...
| **Saving Throw**<br>**Proficiencies** | Strength and Constitution |
| **Skill Proficiencies**<br>_Choose 2:_ Acrobatics, Animal<br>Handling, Athletics, History,<br>Insight, Intimidation, Persua-<br>sion, Perception, or Survival |  |
| **Weapon Proficiencies** | Simple and Martial weapons |
...
<!-- source_txt: srd_extract/run2/pages/p048.txt -->
<!-- source_image: srd_extract/run2/images/p048.png -->
...
<!-- source_txt: srd_extract/run2/pages/p049.txt -->
<!-- source_image: srd_extract/run2/images/p049.png -->
...
you these benefits.
_**Defy Death.**_ You have Advantage on Death Saving
Throws. Moreover, when you roll 18–20 on a Death
Saving Throw, you gain the benefit of rolling a 20 on
it.
_**Heroic Rally.**_ At the start of each of your turns,
...
| **Skill Proficiencies**<br>_Choose 2:_ Acrobatics, Athlet-<br>ics, History, Insight, Religion,<br>or Stealth |  |
| **Weapon Proficiencies** | Simple weapons and Martial<br>weapons that have the Light<br>property |
| **Tool Proficiencies**<br>_Choose one type of Artisan’s_<br>_Tools or Musical Instrument_(see<br>“Equipment”) |  |
| **Armor Training** | None |
...
<!-- source_txt: srd_extract/run2/pages/p050.txt -->
<!-- source_image: srd_extract/run2/images/p050.png -->

**Monk Features**

**Proficiency** **Martial** **Focus** **Unarmored**
**Level** **Bonus** **Class Features** **Arts** **Points** **Movement**
...
_**Martial Arts Die.**_ You can roll 1d6 in place of the
...
Features table.
_**Dexterous Attacks.**_ You can use your Dexterity
...
_**Flurry of Blows.**_ You can expend 1 Focus Point to
make two Unarmed Strikes as a Bonus Action.
_**Patient Defense.**_ You can take the Disengage
action as a Bonus Action. Alternatively, you can

## Page 51

<!-- source_txt: srd_extract/run2/pages/p051.txt -->
<!-- source_image: srd_extract/run2/images/p051.png -->

expend 1 Focus Point to take both the Disengage
and the Dodge actions as a Bonus Action.
_**Step of the Wind.**_ You can take the Dash action
...
_**Flurry of Blows.**_ You can expend 1 Focus Point
to use Flurry of Blows and make three Unarmed
Strikes with it instead of two.

## Page 52

<!-- source_txt: srd_extract/run2/pages/p052.txt -->
<!-- source_image: srd_extract/run2/images/p052.png -->

_**Patient Defense.**_ When you expend a Focus Point
to use Patient Defense, you gain a number of Temporary Hit Points equal to two rolls of your Martial
Arts die.
_**Step of the Wind.**_ When you expend a Focus Point
...
<!-- source_txt: srd_extract/run2/pages/p053.txt -->
<!-- source_image: srd_extract/run2/images/p053.png -->
...
| **Saving Throw**<br>**Proficiencies** | Wisdom and Charisma |
| **Skill Proficiencies**<br>_Choose 2:_ Athletics, Insight,<br>Intimidation, Medicine,<br>Persuasion, or Religion |  |
| **Weapon Proficiencies** | Simple and Martial weapons |
| **Armor Training** | Light, Medium, and Heavy armor and Shields |
...
**Proficiency** **Channel** **Prepared**
**Bonus** **Class Features** **Divinity** **Spells**
...
<!-- source_txt: srd_extract/run2/pages/p054.txt -->
<!-- source_image: srd_extract/run2/images/p054.png -->
...
_**Spell Slots.**_ The Paladin Features table shows
how many spell slots you have to cast your level 1+
spells. You regain all expended slots when you finish a Long Rest.
_**Prepared Spells of Level 1+.**_ You prepare the
list of level 1+ spells that are available for you to
cast with this feature. To start, choose two level
1 Paladin spells. _Heroism_ and _Searing Smite_ are
recommended.
...
_**Blessed Warrior.**_ You learn two Cleric cantrips of
your choice (see the Cleric class’s section for a list
of Cleric spells). _Guidance_ and _Sacred Flame_ are recommended. The chosen cantrips count as Paladin
...
You always have the _Divine Smite_ spell prepared. In
...
<!-- source_txt: srd_extract/run2/pages/p055.txt -->
<!-- source_image: srd_extract/run2/images/p055.png -->

If a Channel Divinity effect requires a saving
throw, the DC equals the spell save DC from this
class’s Spellcasting feature.
_**Divine Sense.**_ As a Bonus Action, you can open
...
place or object that has been consecrated or desecrated, as with the _Hallow_ spell.
...
always have the _Find Steed_ spell prepared.
...
In the Special column, _C_ means the spell requires
Concentration, _R_ means it’s a Ritual, and _M_ means it
...
<!-- source_txt: srd_extract/run2/pages/p056.txt -->
<!-- source_image: srd_extract/run2/images/p056.png -->
...
<!-- source_txt: srd_extract/run2/pages/p057.txt -->
<!-- source_image: srd_extract/run2/images/p057.png -->

**Level 15: Smite of Protection**
Your magical smite now radiates protective energy.
Whenever you cast _Divine Smite_, you and your allies
...
| **Saving Throw**<br>**Proficiencies** | Strength and Dexterity |
| **Skill Proficiencies**<br>_Choose 3:_ Animal Handling,<br>Athletics, Insight, Investigation,<br>Nature, Perception, Stealth, or<br>Survival |  |
| **Weapon Proficiencies** | Simple and Martial weapons |
| **Armor Training** | Light and Medium armor and Shields |
...
_**Spell Slots.**_ The Ranger Features table shows
how many spell slots you have to cast your level 1+
spells. You regain all expended slots when you finish a Long Rest.

## Page 58

<!-- source_txt: srd_extract/run2/pages/p058.txt -->
<!-- source_image: srd_extract/run2/images/p058.png -->

**Ranger Features**



**Proficiency** **Favored** **Prepared**
**Bonus** **Class Features** **Enemy** **Spells**
...
Ranger spells. _Cure Wounds_ and _Ensnaring Strike_ are
recommended.
The number of spells on your list increases as you
...
You always have the _Hunter’s Mark_ spell prepared.
...
<!-- source_txt: srd_extract/run2/pages/p059.txt -->
<!-- source_image: srd_extract/run2/images/p059.png -->
...
benefits.
_**Expertise.**_ Choose one of your skill proficiencies
with which you lack Expertise. You gain Expertise
in that skill.
_**Languages.**_ You know two languages of your
...
_**Druidic Warrior.**_ You learn two Druid cantrips of
your choice (see the Druid class’s section for a list of
Druid spells). _Guidance_ and _Starry Wisp_ are recommended. The chosen cantrips count as Ranger spells
...
granting you the following benefits.
_**Temporary Hit Points.**_ As a Magic action, you can
...
Long Rest.
_**Decrease Exhaustion.**_ Whenever you finish a
...
**Level 20: Foe Slayer**
The damage die of your _Hunter’s Mark_ is a d10
rather than a d6.

## Page 60

<!-- source_txt: srd_extract/run2/pages/p060.txt -->
<!-- source_image: srd_extract/run2/images/p060.png -->
...
<!-- source_txt: srd_extract/run2/pages/p061.txt -->
<!-- source_image: srd_extract/run2/images/p061.png -->
...
creature is marked by your _Hunter’s Mark_, you know
...
one.
_**Colossus Slayer.**_ Your tenacity can wear down
...
per turn.
_**Horde Breaker.**_ Once on each of your turns when
...
_**Multiattack Defense.**_ When a creature hits you
...
marked by your _Hunter’s Mark_, you can also deal
...
| **Skill Proficiencies**<br>_Choose 4:_ Acrobatics, Ath-<br>letics, Deception, Insight,<br>Intimidation, Investigation,<br>Perception, Persuasion, Sleight<br>of Hand, or Stealth |  |
...
**Starting Equipment** _Choose A or B:_ (A) Leather Armor, 2 Daggers, Shortsword,
...
<!-- source_txt: srd_extract/run2/pages/p062.txt -->
<!-- source_image: srd_extract/run2/images/p062.png -->
...
<!-- source_txt: srd_extract/run2/pages/p063.txt -->
<!-- source_image: srd_extract/run2/images/p063.png -->
...
Proficiency Bonus.
_**Poison (Cost: 1d6).**_ You add a toxin to your strike,
...
on your person.
_**Trip (Cost: 1d6).**_ If the target is Large or smaller,
it must succeed on a Dexterity saving throw or have
the Prone condition.
_**Withdraw (Cost: 1d6).**_ Immediately after the
...
itself on a success.
_**Obscure (Cost: 3d6).**_ The target must succeed on
...
<!-- source_txt: srd_extract/run2/pages/p064.txt -->
<!-- source_image: srd_extract/run2/images/p064.png -->
...
_**Sleight of Hand.**_ Make a Dexterity (Sleight of
Hand) check to pick a lock or disarm a trap with
Thieves’ Tools or to pick a pocket.
_**Use an Object.**_ Take the Utilize action, or take the
...
_**Climber.**_ You gain a Climb Speed equal to your
Speed.
_**Jumper.**_ You can determine your jump distance
using your Dexterity rather than your Strength.

**Level 9: Supreme Sneak**
You gain the following Cunning Strike option.
_**Stealth Attack (Cost: 1d6).**_ If you have the Hide
...
granting you the following benefits.
_**Attunement.**_ You can attune to up to four magic
items at once.
_**Charges.**_ Whenever you use a magic item property that expends charges, roll 1d6. On a roll of
6, you use the property without expending the
charges.
_**Scrolls.**_ You can use any _Spell Scroll_, using Intelligence as your spellcasting ability for the spell. If the
...
| **Skill Proficiencies**<br>_Choose 2:_ Arcana, Deception,<br>Insight, Intimidation, Persua-<br>sion, or Religion |  |
| **Weapon Proficiencies** | Simple weapons |
| **Armor Training** | None |
...
_**Cantrips.**_ You know four Sorcerer cantrips of your
choice. _Light_, _Prestidigitation_, _Shocking Grasp_, and
_Sorcerous Burst_ are recommended. Whenever you
...
_**Spell Slots.**_ The Sorcerer Features table shows
how many spell slots you have to cast your level 1+

## Page 65

<!-- source_txt: srd_extract/run2/pages/p065.txt -->
<!-- source_image: srd_extract/run2/images/p065.png -->

**Sorcerer Features**



**Proficiency** **Sorcery** **Prepared**
**Bonus** **Class Features** **Points** **Cantrips** **Spells**
...
_**Prepared Spells of Level 1+.**_ You prepare the list
of level 1+ spells that are available for you to cast
with this feature. To start, choose two level 1 Sorcerer spells. _Burning Hands_ and _Detect Magic_ are
recommended.
The number of spells on your list increases as
...
_**Spellcasting Focus.**_ You can use an Arcane Focus
...
<!-- source_txt: srd_extract/run2/pages/p066.txt -->
<!-- source_image: srd_extract/run2/images/p066.png -->
...
<!-- source_txt: srd_extract/run2/pages/p067.txt -->
<!-- source_image: srd_extract/run2/images/p067.png -->
...
When you cast a spell, such as _Charm Person_, that
...
<!-- source_txt: srd_extract/run2/pages/p068.txt -->
<!-- source_image: srd_extract/run2/images/p068.png -->
...
<!-- source_txt: srd_extract/run2/pages/p069.txt -->
<!-- source_image: srd_extract/run2/images/p069.png -->
...
<!-- source_txt: srd_extract/run2/pages/p070.txt -->
<!-- source_image: srd_extract/run2/images/p070.png -->
...
You can cast _Summon Dragon_ without a Material
...
| **Saving Throw**<br>**Proficiencies** | Wisdom and Charisma |
| **Skill Proficiencies**<br>_Choose 2:_ Arcana, Deception,<br>History, Intimidation, Investi-<br>gation, Nature, or Religion |  |
| **Weapon Proficiencies** | Simple weapons |
| **Armor Training** | Light armor |
...
_**Prerequisites.**_ If an invocation has a prerequisite, you must meet it to learn that invocation. For
example, if an invocation requires you to be a level
5+ Warlock, you can select the invocation once you
reach Warlock level 5.
_**Replacing and Gaining Invocations.**_ Whenever
you gain a Warlock level, you can replace one of
your invocations with another one for which you

## Page 71

<!-- source_txt: srd_extract/run2/pages/p071.txt -->
<!-- source_image: srd_extract/run2/images/p071.png -->
...
_**Cantrips.**_ You know two Warlock cantrips of your
choice. _Eldritch Blast_ and _Prestidigitation_ are recommended. Whenever you gain a Warlock level, you
...
_**Spell Slots.**_ The Warlock Features table shows
...
_Charm Person_, you must spend one of those slots,
...
level 1 Warlock spells. _Charm Person_ and _Hex_ are
recommended.
The number of spells on your list increases as you
...
<!-- source_txt: srd_extract/run2/pages/p072.txt -->
<!-- source_image: srd_extract/run2/images/p072.png -->
...
level.
_**Spellcasting Ability.**_ Charisma is the spellcasting
...
directly; you always have the _Contact Other Plane_
...
**Agonizing Blast**
_Prerequisite: Level 2+ Warlock, a Warlock Cantrip_
_That Deals Damage_
...
_**Repeatable.**_ You can gain this invocation more
...
You can cast _Levitate_ on yourself without expending
a spell slot.
...
**Devouring Blade**
_Prerequisite: Level 12+ Warlock, Thirsting Blade_
_Invocation_
...
<!-- source_txt: srd_extract/run2/pages/p073.txt -->
<!-- source_image: srd_extract/run2/images/p073.png -->
...
You can cast _False Life_ on yourself without expending a spell slot. When you cast the spell with this
...
You can also cast _Water Breathing_ once without
...
A new page appears in your _Book of Shadows_ when
...
When you cast _Find Familiar_, you infuse the summoned familiar with a measure of your eldritch
power, granting the creature the following benefits.
_**Aerial or Aquatic.**_ The familiar gains either a Fly
...
_**Necrotic or Radiant Damage.**_ Whenever the
familiar deals Bludgeoning, Piercing, or Slashing
damage, you can make it deal Necrotic or Radiant
damage instead.
_**Your Save DC.**_ If the familiar forces a creature to
make a saving throw, it uses your spell save DC.
_**Resistance.**_ When the familiar takes damage, you
...
You can cast _Disguise Self_ without expending a spell
slot.

**Master of Myriad Forms**
_Prerequisite: Level 5+ Warlock_

You can cast _Alter Self_ without expending a spell
slot.

## Page 74

<!-- source_txt: srd_extract/run2/pages/p074.txt -->
<!-- source_image: srd_extract/run2/images/p074.png -->

**Misty Visions**
_Prerequisite: Level 2+ Warlock_

You can cast _Silent Image_ without expending a spell
slot.
...
you can cast _Invisibility_ on yourself without expending a spell slot.

**Otherworldly Leap**
_Prerequisite: Level 2+ Warlock_

You can cast _Jump_ on yourself without expending a
spell slot.
...
**Pact of the Chain**
You learn the _Find Familiar_ spell and can cast it as a
...
Long Rest. This _Book of Shadows_ (you determine its
...
_**Cantrips and Rituals.**_ When the book appears,
...
_**Spellcasting Focus.**_ You can use the book as a
Spellcasting Focus.

**Repelling Blast**
_Prerequisite: Level 2+ Warlock, a Warlock Cantrip_
_That Deals Damage via an Attack Roll_
...
You can cast _Arcane Eye_ without expending a spell
slot.

**Whispers of the Grave**
_Prerequisite: Level 7+ Warlock_

You can cast _Speak with Dead_ without expending a
spell slot.
...
<!-- source_txt: srd_extract/run2/pages/p075.txt -->
<!-- source_image: srd_extract/run2/images/p075.png -->
...
<!-- source_txt: srd_extract/run2/pages/p076.txt -->
<!-- source_image: srd_extract/run2/images/p076.png -->
...
<!-- source_txt: srd_extract/run2/pages/p077.txt -->
<!-- source_image: srd_extract/run2/images/p077.png -->
...
| **Saving Throw**<br>**Proficiencies** | Intelligence and Wisdom |
| **Skill Proficiencies**<br>_Choose 2:_ Arcana, History, In-<br>sight, Investigation, Medicine,<br>Nature, or Religion |  |
| **Weapon Proficiencies** | Simple weapons |
| **Armor Training** | None |
...
_**Cantrips.**_ You know three Wizard cantrips of your
choice. _Light_, _Mage Hand_, and _Ray of Frost_ are recommended. Whenever you finish a Long Rest, you
can replace one of your cantrips from this feature
with another Wizard cantrip of your choice.



**Proficiency** **Prepared**
**Bonus** **Class Features** **Cantrips** **Spells**
...
<!-- source_txt: srd_extract/run2/pages/p078.txt -->
<!-- source_image: srd_extract/run2/images/p078.png -->
...
_**Spellbook.**_ Your wizardly apprenticeship culminated in the creation of a unique book: your
spellbook. It is a Tiny object that weighs 3 pounds,
contains 100 pages, and can be read only by you or
someone casting _Identify_. You determine the book’s
...
_Detect Magic_, _Feather Fall_, _Mage Armor_, _Magic Missile_, _Sleep_, and _Thunderwave_ are recommended.
...
you do regularly.
_**Spell Slots.**_ The Wizard Features table shows
how many spell slots you have to cast your level 1+
spells. You regain all expended slots when you finish a Long Rest.
_**Prepared Spells of Level 1+.**_ You prepare the list
of level 1+ spells that are available for you to cast
...
you can add to the book. You could discover a Wizard spell on a _Spell Scroll_, for example, and then copy
it into your spellbook.

_**Copying a Spell into the Book.**_ When you find a
level 1+ Wizard spell, you can copy it into your
...
_**Copying the Book.**_ You can copy a spell from
...
<!-- source_txt: srd_extract/run2/pages/p079.txt -->
<!-- source_image: srd_extract/run2/images/p079.png -->
...
<!-- source_txt: srd_extract/run2/pages/p080.txt -->
<!-- source_image: srd_extract/run2/images/p080.png -->
...
<!-- source_txt: srd_extract/run2/pages/p081.txt -->
<!-- source_image: srd_extract/run2/images/p081.png -->
...
<!-- source_txt: srd_extract/run2/pages/p082.txt -->
<!-- source_image: srd_extract/run2/images/p082.png -->
