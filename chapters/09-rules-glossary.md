...
<!-- source_txt: srd_extract/run2/pages/p176.txt -->
<!-- source_image: srd_extract/run2/images/p176.png -->
...
has that condition.
**“See Also.”** Some glossary entries include a _See also_
...
with an ability—to overcome a challenge. _See also_
...
you to do so. _See also_ “Playing the Game” (“The Six
Abilities”).

**Action**
On your turn, you can take one action. Choose which
action to take from those below or from the special
actions provided by your features. _See also_ “Playing
...
| M | Material<br>component |
| --- | --- |
| **N** | Neutral |
| **NE** | Neutral Evil |
| **NG** | Neutral Good |
| **NPC** | Nonplayer<br>character |
| **PB** | Proficiency Bonus |
| **PP** | Platinum Piece(s) |
| **R** | Ritual |
| **S** | Somatic<br>component |
| **SP** | Silver Piece(s) |
| **Str.** | Strength |
| **V** | Verbal component |
| **Wis.** | Wisdom |
...
more than one Advantage, and Advantage and Disadvantage on the same roll cancel each other. _See_
_also_ “Playing the Game” (“D20 Tests”).

**Adventure**
An adventure is a series of encounters. A
story emerges through playing them. _See also_
“Encounter.”
...
Good and Neutral Evil. _See also_ “Character Creation”
...
<!-- source_txt: srd_extract/run2/pages/p177.txt -->
<!-- source_image: srd_extract/run2/images/p177.png -->
...
use more than one. _See also_ “Attack Roll.”
...
it, you don’t gain its AC bonus. _See also_ “Disadvantage” and “Equipment” (“Armor”).

**Attack [Action]**
When you take the Attack action, you can make one
attack roll with a weapon or an Unarmed Strike.
_**Equipping and Unequipping Weapons.**_ You can
...
_**Moving between Attacks.**_ If you move on your
...
spell. _See also_ “Playing the Game” (“D20 Tests”).

**Attitude**
A monster has a starting attitude toward a player
character: Friendly, Hostile, or Indifferent. _See also_
...
three magic items at a time. _See also_ “Equipment”
(“Magic Items”).
...
_**Attacks Affected.**_ Attack rolls against you have
...
says so. _See also_ “Playing the Game” (“Actions”).
...
_**Armor Class.**_ The Object Armor Class table suggests ACs for various substances.

## Page 178

<!-- source_txt: srd_extract/run2/pages/p178.txt -->
<!-- source_image: srd_extract/run2/images/p178.png -->
...
_**Hit Points.**_ An object is destroyed when it has 0
...
_**Damage Types and Objects.**_ Objects have Immunity to Poison and Psychic damage. The GM might
...
_**Damage Threshold.**_ Big objects, such as castle
walls, often have extra resilience represented by a
damage threshold. _See also_ “Damage Threshold.”
_**No Ability Scores.**_ An object lacks ability scores
...
creature has a trait that allows it to do so. _See also_
“Speed.”
...
**Campaign**
A campaign is a series of adventures. _See also_
“Adventure.”

**Cantrip**
A cantrip is a level 0 spell, which is cast without a
spell slot. _See also_ “Spells.”
...
CR while planning potential combat encounters. _See_
_also_ “Stat Block.”

**Character Sheet**
A character sheet is a paper or digital record that
you use to track your character’s information. _See_
_also_ “Character Creation.”

**Charmed [Condition]**
While you have the Charmed condition, you experience the following effects.
_**Can’t Harm the Charmer.**_ You can’t attack the
charmer or target the charmer with damaging abilities or magical effects.
_**Social Advantage.**_ The charmer has Advantage on
...
<!-- source_txt: srd_extract/run2/pages/p179.txt -->
<!-- source_image: srd_extract/run2/images/p179.png -->
...
movement normally associated with climbing. _See_
_also_ “Climbing” and “Speed.”
...
_**Another Concentration Effect.**_ You lose Concentration on an effect the moment you start casting
...
maximum DC of 30.
_**Incapacitated or Dead.**_ Your Concentration ends
...
cover, a target benefits only from the most protective degree. _See also_ “Playing the Game” (“Combat”).

**Crawling**
While you’re crawling, each foot of movement costs
1 extra foot (2 extra feet in Difficult Terrain). _See_
_also_ “Speed.”
...
and add them together. Then add any relevant modifiers. _See also_ “Playing the Game” (“Damage and
Healing”).
...
curse does. Curses can be removed by the _Remove_
_Curse_ and _Greater Restoration_ spells or other magic
...
<!-- source_txt: srd_extract/run2/pages/p180.txt -->
<!-- source_image: srd_extract/run2/images/p180.png -->
...
whether a D20 Test is warranted in a given circumstance. _See also_ “Playing the Game” (“D20 Tests”).
...
**Damage Roll**
A damage roll is a die roll, adjusted by any applicable modifiers, that deals damage to a target. _See also_
...
**Darkness**
An area of Darkness is Heavily Obscured. _See_
_also_ “Heavily Obscured” and “Playing the Game”
(“Exploration”).
...
only as shades of gray. _See also_ “Playing the Game”
(“Exploration”).
...
speed to use each time you take it. _See also_ “Speed.”

**Dead**
A dead creature has no Hit Points and can’t regain
them unless it is first revived by magic such as the
_Raise Dead_ or _Revivify_ spell. When such a spell is
...
<!-- source_txt: srd_extract/run2/pages/p181.txt -->
<!-- source_image: srd_extract/run2/images/p181.png -->

**Deafened [Condition]**
While you have the Deafened condition, you experience the following effect.
_**Can’t Hear.**_ You can’t hear and automatically fail
...
turn with 0 Hit Points. _See also_ “Playing the Game”
(“Damage and Healing”).
...
full amount of water required for a day. _See also_
“Exhaustion.”
...
ability check or a saving throw. _See also_ “Playing the
Game” (“D20 Tests”).

**Dim Light**
An area with Dim Light is Lightly Obscured. _See_
_also_ “Lightly Obscured” and “Playing the Game”
(“Exploration”).
...
Disadvantage on the same roll cancel each other. _See_
_also_ “Playing the Game” (“D20 Tests”).
...
of at least one of the game’s three pillars: social interaction, exploration, or combat. _See also_ “Playing
...
_**Exhaustion Levels.**_ This condition is cumulative.
Each time you receive it, you gain 1 Exhaustion
level. You die if your Exhaustion level is 6.
_**D20 Tests Affected.**_ When you make a D20 Test,
...
_**Removing Exhaustion Levels.**_ Finishing a Long
Rest removes 1 of your Exhaustion levels. When
your Exhaustion level reaches 0, the condition ends.

## Page 182

<!-- source_txt: srd_extract/run2/pages/p182.txt -->
<!-- source_image: srd_extract/run2/images/p182.png -->
...
the character’s level increases. _See also_ “Level
Advancement.”
...
_**Movable.**_ The grappler can drag or carry you
...
initiated, it follows these rules. _See also_ “Unarmed
Strike” and “Grappled.”
_**Grappled Condition.**_ Successfully grappling a
creature gives it the Grappled condition.
_**One Grapple per Hand.**_ A creature must have a
...
it ends the grapple.
_**Ending a Grapple.**_ A Grappled creature can use
...
**Hazard**
A hazard is an environmental danger. _See also_
...
something in a Heavily Obscured space. _See also_
...
following.
_**Assist an Ability Check.**_ Choose one of your
skill or tool proficiencies and one ally who is near

## Page 183

<!-- source_txt: srd_extract/run2/pages/p183.txt -->
<!-- source_image: srd_extract/run2/images/p183.png -->
...
_**Assist an Attack Roll.**_ You momentarily distract
...
a Short Rest to regain Hit Points. _See also_ “Short
Rest.”
...
maximum, and you can’t have less than 0. _See also_
“Breaking Objects” and “Playing the Game” (“Damage and Healing”).

**Hostile [Attitude]**
A Hostile creature views you unfavorably. You have
Disadvantage on an ability check to influence a Hostile creature. _See also_ “Influence.”
...
you from falling in certain circumstances. _See also_
“Flying.”
...
_**Proficiency.**_ Don’t add your Proficiency Bonus to
attack rolls with an improvised weapon.
_**Damage.**_ On a hit, the weapon deals 1d4 damage
of a type the GM thinks is appropriate for the object.
_**Range.**_ If you throw the weapon, it has a normal
range of 20 feet and a long range of 60 feet.
_**Weapon Equivalents.**_ If an improvised weapon
...
<!-- source_txt: srd_extract/run2/pages/p184.txt -->
<!-- source_image: srd_extract/run2/images/p184.png -->

**Incapacitated [Condition]**
While you have the Incapacitated condition, you experience the following effects.
_**Inactive.**_ You can’t take any action, Bonus Action,
or Reaction.
_**No Concentration.**_ Your Concentration is broken.
_**Speechless.**_ You can’t speak.
_**Surprised.**_ If you’re Incapacitated when you roll
...
_**Willing.**_ If your urging aligns with the monster’s
desires, no ability check is necessary; the monster
fulfills your request in a way it prefers.
_**Unwilling.**_ If your urging is repugnant to the monster or counter to its alignment, no ability check is
necessary; it doesn’t comply.
_**Hesitant.**_ If you urge the monster to do something
...
_**Concealed.**_ You aren’t affected by any effect that
...
**Jumping**
When you jump, you make either a Long Jump (horizontal) or a High Jump (vertical). _See also_ “Long
Jump” and “High Jump.”
...
space. _See also_ “Dim Light” and “Playing the Game”
(“Exploration”).
...
<!-- source_txt: srd_extract/run2/pages/p185.txt -->
<!-- source_image: srd_extract/run2/images/p185.png -->
...
_**Benefits of the Rest.**_ To start a Long Rest, you
...
_**Interrupting the Rest.**_ A Long Rest is stopped by
...
you gain the benefits of a Short Rest. _See also_ “Short
Rest.”
...
spell slot. _See also_ “Concentration.”
...
food required for a day. _See also_ “Exhaustion.”
...
if the creature is benevolent. _See also_ “Creature” and
“NPC.”

**Nonplayer Character**
A nonplayer character (NPC) is a monster that has
a personal name and a distinct personality. _See also_
“Monster.”

**Object**
An object is a nonliving, distinct thing. Composite
things, like buildings, comprise more than one object. _See also_ “Breaking Objects.”
...
your reach. _See also_ “Playing the Game” (“Combat”).

## Page 186

<!-- source_txt: srd_extract/run2/pages/p186.txt -->
<!-- source_image: srd_extract/run2/images/p186.png -->

**Paralyzed [Condition]**
While you have the Paralyzed condition, you experience the following effects.
_**Incapacitated.**_ You have the Incapacitated
condition.
_**Speed 0.**_ Your Speed is 0 and can’t increase.
_**Saving Throws Affected.**_ You automatically fail
Strength and Dexterity saving throws.
_**Attacks Affected.**_ Attack rolls against you have
Advantage.
_**Automatic Critical Hits.**_ Any attack roll that hits
...
_**Turned to Inanimate Substance.**_ You are transformed, along with any nonmagical objects you are
...
be prevented by the _Protection from Evil and Good_
spell and ended by the _Dispel Evil and Good_ spell.
...
_**Restricted Movement.**_ Your only movement options are to crawl or to spend an amount of movement equal to half your Speed (round down) to
right yourself and thereby end the condition. If your
Speed is 0, you can’t right yourself.
_**Attacks Affected.**_ You have Disadvantage on attack rolls. An attack roll against you has Advantage
...
Attack is a Reaction available to all creatures. _See_
_also_ “Opportunity Attacks” and “Playing the Game”
(“Actions”).
...
<!-- source_txt: srd_extract/run2/pages/p187.txt -->
<!-- source_image: srd_extract/run2/images/p187.png -->
...
damage. _See also_ “Playing the Game” (“Damage and
Healing”).
...
_**Attacks Affected.**_ Attack rolls against you have
Advantage, and your attack rolls have Disadvantage.
_**Saving Throws Affected.**_ You have Disadvantage
...
higher level. _See also_ “Spells.”
...
**Save**
Save is another name for a saving throw. _See also_
“Saving Throw.”
...
and lacks the ability score used by it, the target automatically fails. _See also_ “Playing the Game” (“D20
Tests”).
...
**Shape-Shifting**
If an effect, such as Wild Shape or the _Polymorph_
...
_**Benefits of the Rest.**_ When you finish the rest, you
...
_**Interrupting the Rest.**_ A Short Rest is stopped by
the following interruptions:
...
<!-- source_txt: srd_extract/run2/pages/p188.txt -->
<!-- source_image: srd_extract/run2/images/p188.png -->
...
its Hit Points. _See also_ “Breaking Objects” and “Playing the Game” (“Combat”).
...
an ability check associated with that skill. _See also_
...
_See also_ “Climbing,” “Crawling,” “Flying,” “Jumping,”
“Swimming” and “Playing the Game” (“Combat”).
_**Special Speeds.**_ Some creatures have special
...
_**Changes to Your Speeds.**_ If an effect increases or
...
or another magical effect. _See also_ “Spells” (“Casting
Spells”).
...
allow its members to use certain types of Spellcasting Focuses. _See also_ “Spells” (“Casting Spells”).
...
required to make Death Saving Throws. _See also_
“Playing the Game” (“Damage and Healing”).
...
_**Size.**_ A monster is Tiny, Small, Medium, Large,
Huge, or Gargantuan. _See also_ “Size.”
...
_**Alignment.**_ An alignment is suggested for the
monster, with the GM determining its actual alignment. _See also_ “Alignment.”
_**AC, Initiative, and HP.**_ These entries give the
...
_**Speed.**_ Here the monster’s Speed is provided,
along with any special speeds. _See also_ “Burrow
Speed,” “Climb Speed,” “Fly Speed,” and “Swim
Speed.”
_**Ability Scores.**_ A table provides the monster’s
ability scores, modifiers, and saving throw modifiers, all of which are detailed in “Playing the Game.”
_**Skills.**_ This entry lists the monster’s skill proficiencies, if any. _See also_ “Playing the Game”
(“Proficiency”).
_**Resistances and Vulnerabilities.**_ These entries
list the monster’s Resistances and Vulnerabilities, if
any. _See also_ “Resistance” and “Vulnerability.”
_**Immunities.**_ This section lists the monster’s
damage and condition Immunities, if any. _See also_
“Immunity.”
_**Gear.**_ If the monster has any equipment that can
be given away or retrieved, it’s listed in this entry.
_**Senses.**_ This entry lists the monster’s special
senses, such as Darkvision, and its Passive Perception. _See also_ “Passive Perception.”
_**Languages.**_ This entry lists any languages the
monster knows.

## Page 189

<!-- source_txt: srd_extract/run2/pages/p189.txt -->
<!-- source_image: srd_extract/run2/images/p189.png -->

_**CR.**_ Challenge Rating summarizes the threat a
...
creatures that are created by magic have no CR. _See_
_also_ “Challenge Rating” and “Experience Points.”
_**Traits.**_ The monster’s traits, if any, are features
that are active at all times or in certain situations.
_**Actions.**_ The monster can take these actions in
addition to those detailed in this glossary. _See also_
“Playing the Game” (“Actions”).
_**Bonus Actions.**_ If the monster has Bonus Action
...
_**Attack Notation.**_ The entry for a monster’s attack
...
_**Saving Throw Effect Notation.**_ If an effect forces
...
_**Damage Notation.**_ A stat block usually provides
...
| Religion | Deities, religious hierarchies and rites,<br>holy symbols, cults, and certain creatures<br>(Celestials, Fiends, and Undead) |
...
to have Disadvantage on its Initiative roll. _See also_
...
swimming. _See also_ “Swimming” and “Speed.”

## Page 190

<!-- source_txt: srd_extract/run2/pages/p190.txt -->
<!-- source_image: srd_extract/run2/images/p190.png -->
...
and act as a buffer against losing real Hit Points. _See_
_also_ “Playing the Game” (“Damage and Healing”).
...
_**Damage.**_ You make an attack roll against the
...
_**Grapple.**_ The target must succeed on a Strength
...
grab it. _See also_ “Grappling.”
_**Shove.**_ The target must succeed on a Strength or
...
<!-- source_txt: srd_extract/run2/pages/p191.txt -->
<!-- source_image: srd_extract/run2/images/p191.png -->

**Unconscious [Condition]**
While you have the Unconscious condition, you experience the following effects.
_**Inert.**_ You have the Incapacitated and Prone
...
applied only once to an instance of damage. _See also_
“Playing the Game” (“Damage and Healing”).

**Weapon**
A weapon is an object that is in the Simple or
Martial weapon category. _See also_ “Equipment”
(“Weapons”).

**Weapon Attack**
A weapon attack is an attack roll made with a
weapon. _See also_ “Weapon.”
