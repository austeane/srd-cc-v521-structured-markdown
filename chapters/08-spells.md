...
<!-- source_txt: srd_extract/run2/pages/p104.txt -->
<!-- source_image: srd_extract/run2/images/p104.png -->
...
from a magic item, such as a _Spell Scroll_ . Your features specify which spells you have access to, if any;
...
least level 2. So when a level 3 Wizard casts _Magic_
_Missile_, a level 1 spell, that Wizard spends one of
...
**Magic Items.** _Spell Scrolls_ and some other magic
...
Wizard casts _Magic Missile_ using a level 2 slot, that
_Magic Missile_ is level 2. Effectively, the spell expands
to fill the slot it is put into.

## Page 105

<!-- source_txt: srd_extract/run2/pages/p105.txt -->
<!-- source_image: srd_extract/run2/images/p105.png -->

Some spells, such as _Magic Missile_ and _Cure_
_Wounds_, have more powerful effects when cast at a
...
<!-- source_txt: srd_extract/run2/pages/p106.txt -->
<!-- source_image: srd_extract/run2/images/p106.png -->
...
_**A Clear Path to the Target.**_ To target something
with a spell, a caster must have a clear path to it, so
it can’t be behind Total Cover.
_**Targeting Yourself.**_ If a spell targets a creature
of your choice, you can choose yourself unless the
creature must be Hostile or specifically a creature
other than you.
_**Areas of Effect.**_ Some spells, such as _Thunder-_
_wave_, cover an area called an area of effect, which
...
_**Awareness of Being Targeted.**_ Unless a spell has
...
_**Invalid Targets.**_ If you cast a spell on someone
...
overlap. For example, if two Clerics cast _Bless_ on
...
continues until the duration of the second _Bless_
ends.
...
**Aid**
_Level 2 Abjuration (Bard, Cleric, Druid, Paladin,_
_Ranger)_
...
_**Using a Higher-Level Spell Slot.**_ Each target’s Hit
...
_**Change Appearance.**_ You alter your appearance. You decide what you look like, including your
...
this way again.
_**Natural Weapons.**_ You grow claws (Slashing),
...
<!-- source_txt: srd_extract/run2/pages/p108.txt -->
<!-- source_image: srd_extract/run2/images/p108.png -->

or one of your allies deals damage to the target, the
spell ends.
_**Using a Higher-Level Spell Slot.**_ You can target
...
_**Using a Higher-Level Spell Slot.**_ The spell’s duration increases by 48 hours for each spell slot level
above 2.
...
_**Using a Higher-Level Spell Slot.**_ You animate or
...
<!-- source_txt: srd_extract/run2/pages/p109.txt -->
<!-- source_image: srd_extract/run2/images/p109.png -->
...
_**Using a Higher-Level Spell Slot.**_ The creature’s
...
_**Slam.**_ _Melee Attack Roll:_ Bonus equals your spell attack
modifier, reach 5 ft. _Hit:_ Force damage equal to 1d4
...
_Dispel Magic_ has no effect on the aura, and the auras created by different _Antimagic Field_ spells don’t
nullify each other.
...
<!-- source_txt: srd_extract/run2/pages/p110.txt -->
<!-- source_image: srd_extract/run2/images/p110.png -->

Wisdom saving throw to end the effect, as described below.

_**Ending the Effect.**_ If the Frightened or Charmed
...
_**Using a Higher-Level Spell Slot.**_ The damage of
...
<!-- source_txt: srd_extract/run2/pages/p111.txt -->
<!-- source_image: srd_extract/run2/images/p111.png -->
...
dispelled.
_**Mask (Creature).**_ Choose a creature type other
than the target’s actual type. Spells and other magical effects treat the target as if it were a creature of
the chosen type.
_**False Aura (Object).**_ You change the way the target appears to spells and magical effects that detect
magical auras, such as _Detect Magic_ . You can make
...
<!-- source_txt: srd_extract/run2/pages/p112.txt -->
<!-- source_image: srd_extract/run2/images/p112.png -->
...
can also be ended by the _Greater Restoration_, _Heal_,
or _Wish_ spell.
...
<!-- source_txt: srd_extract/run2/pages/p113.txt -->
<!-- source_image: srd_extract/run2/images/p113.png -->

     - If you deal damage to the target with an attack
roll or a spell, the target takes an extra 1d8 Necrotic damage.

_**Using a Higher-Level Spell Slot.**_ If you cast this
...
it enters the area or ends its turn there. A creature
...
wall’s space or ends its turn there. A creature makes
...
**Blight**
_Level 4 Necromancy (Druid, Sorcerer, Warlock,_
_Wizard)_
...
<!-- source_txt: srd_extract/run2/pages/p114.txt -->
<!-- source_image: srd_extract/run2/images/p114.png -->
...
_**Using a Higher-Level Spell Slot.**_ One additional
bolt leaps from the first target to another target for
each spell slot level above 6.

**Charm Monster**
_Level 4 Enchantment (Bard, Druid, Sorcerer, Warlock,_
_Wizard)_
...
<!-- source_txt: srd_extract/run2/pages/p115.txt -->
<!-- source_image: srd_extract/run2/images/p115.png -->
...
**Charm Person**
_Level 1 Enchantment (Bard, Druid, Sorcerer, Warlock,_
_Wizard)_
...
_**Cantrip Upgrade.**_ The damage increases by 1d10
...
_**Using a Higher-Level Spell Slot.**_ The damage increases by 1d8 for each spell slot level above 1. The
...
benefiting from _See Invisibility_ or Truesight) sees a
...
<!-- source_txt: srd_extract/run2/pages/p116.txt -->
<!-- source_image: srd_extract/run2/images/p116.png -->
...
one created by _Gust of Wind_ ) disperses it, ending the
...
_**Using a Higher-Level Spell Slot.**_ You can affect
one additional creature for each spell slot level
above 1.
...
<!-- source_txt: srd_extract/run2/pages/p117.txt -->
<!-- source_image: srd_extract/run2/images/p117.png -->
...
| 1d10 | Behavior for the Turn |
| --- | --- |
| 1 | The target doesn’t take an action, and it uses all<br>its movement to move. Roll 1d4 for the direc-<br>tion: 1, north; 2, east; 3, south; or 4, west. |
| 2–6 | The target doesn’t move or take actions. |
| 7–8 | The target doesn’t move, and it takes the At-<br>tack action to make one melee attack against<br>a random creature within reach. If none are<br>within reach, the target takes no action. |
...
success.
_**Using a Higher-Level Spell Slot.**_ The Sphere’s
...
<!-- source_txt: srd_extract/run2/pages/p118.txt -->
<!-- source_image: srd_extract/run2/images/p118.png -->
...
_**Using a Higher-Level Spell Slot.**_ The healing and
...
On a failed save, the target takes 8d8 damage of the
...
<!-- source_txt: srd_extract/run2/pages/p119.txt -->
<!-- source_image: srd_extract/run2/images/p119.png -->
...
Long Rest. A _Greater Restoration_ spell cast on you
ends this effect.
...
target you. You cast that spell—called the contingent spell—as part of casting _Contingency_, expending spell slots for both, but the contingent spell
...
a _Contingency_ cast with _Water Breathing_ might stipulate that _Water Breathing_ comes into effect when
...
not you want it to, and then _Contingency_ ends.
The contingent spell takes effect only on you, even
if it can normally target others. You can use only
one _Contingency_ spell at a time. If you cast this spell
again, the effect of another _Contingency_ spell on you
ends. Also, _Contingency_ ends on you if its material
...
_**Flood.**_ You cause the water level of all standing
water in the area to rise by as much as 20 feet. If you

## Page 120

<!-- source_txt: srd_extract/run2/pages/p120.txt -->
<!-- source_image: srd_extract/run2/images/p120.png -->
...
_**Part Water.**_ You part water in the area and create a trench. The trench extends across the spell’s
...
_**Redirect Flow.**_ You cause flowing water in the
...
effect.
_**Whirlpool.**_ You cause a whirlpool to form in the
...
<!-- source_txt: srd_extract/run2/pages/p121.txt -->
<!-- source_image: srd_extract/run2/images/p121.png -->
...
_**Using a Higher-Level Spell Slot.**_ You create or
...
_**Using a Higher-Level Spell Slot.**_ If you use a level
...
**Cure Wounds**
_Level 1 Abjuration (Bard, Cleric, Druid, Paladin,_
_Ranger)_
...
<!-- source_txt: srd_extract/run2/pages/p122.txt -->
<!-- source_image: srd_extract/run2/images/p122.png -->
...
**Darkvision**
_Level 2 Transmutation (Druid, Ranger, Sorcerer,_
_Wizard)_
...
**Daylight**
_Level 3 Evocation (Cleric, Druid, Paladin, Ranger,_
_Sorcerer)_
...
burning.
_**Using a Higher-Level Spell Slot.**_ The base damage
...
<!-- source_txt: srd_extract/run2/pages/p123.txt -->
<!-- source_image: srd_extract/run2/images/p123.png -->
...
the _Hallow_ spell is active there and, if so, where.
The spell is blocked by 1 foot of stone, dirt, or
wood; 1 inch of metal; or a thin sheet of lead.

**Detect Magic**
_Level 1 Divination (Bard, Cleric, Druid, Paladin,_
_Ranger, Sorcerer, Warlock, Wizard)_
...
on your later turns.
_**Sense Thoughts.**_ You sense the presence of
...
The spell is blocked by 1 foot of stone, dirt, or
wood; 1 inch of metal; or a thin sheet of lead.
_**Read Thoughts.**_ Target one creature you can see
...
<!-- source_txt: srd_extract/run2/pages/p124.txt -->
<!-- source_image: srd_extract/run2/images/p124.png -->
...
as the wall created by _Wall of Force._
...
dust. The target can be revived only by a _True Resurrection_ or a _Wish_ spell.
...
_**Break Enchantment.**_ As a Magic action, you touch
...
_**Dismissal.**_ As a Magic action, you target one creature you can see within 5 feet of you that has one of
...
**Dispel Magic**
_Level 3 Abjuration (Bard, Cleric, Druid, Paladin,_
_Ranger, Sorcerer, Warlock, Wizard)_
...
_**Using a Higher-Level Spell Slot.**_ You automatically end a spell on the target if the spell’s level is
...
<!-- source_txt: srd_extract/run2/pages/p125.txt -->
<!-- source_image: srd_extract/run2/images/p125.png -->
...
_**Using a Higher-Level Spell Slot.**_ Your Concentration can last longer with a spell slot of level 5 (up to
10 minutes), 6 (up to 1 hour), or 7+ (up to 8 hours).

**Dominate Monster**
_Level 8 Enchantment (Bard, Sorcerer, Warlock,_
_Wizard)_
...
<!-- source_txt: srd_extract/run2/pages/p126.txt -->
<!-- source_image: srd_extract/run2/images/p126.png -->
...
You can command the target to take a Reaction
but must take your own Reaction to do so.
_**Using a Higher-Level Spell Slot.**_ Your Concentration can last longer with a level 9 spell slot (up to 8
hours).
...
You can command the target to take a Reaction
but must take your own Reaction to do so.
_**Using a Higher-Level Spell Slot.**_ Your Concentration can last longer with a spell slot of level 6 (up to
...
_**Weather Sensor.**_ You create a Tiny, harmless sensory effect that predicts what the weather will be at
...
_**Bloom.**_ You instantly make a flower blossom, a
seed pod open, or a leaf bud bloom.
_**Sensory Effect.**_ You create a harmless sensory effect, such as falling leaves, spectral dancing fairies,
a gentle breeze, the sound of an animal, or the faint
odor of skunk. The effect must fit in a 5-foot Cube.
_**Fire Play.**_ You light or snuff out a candle, a torch,
or a campfire.

## Page 127

<!-- source_txt: srd_extract/run2/pages/p127.txt -->
<!-- source_image: srd_extract/run2/images/p127.png -->
...
_**Fissures.**_ A total of 1d6 fissures open in the spell’s
...
_**Structures.**_ The tremor deals 50 Bludgeoning
...
_**Cantrip Upgrade.**_ The spell creates two beams at
...
_**Beckon Air.**_ You create a breeze strong enough to
...
aren’t affected.
_**Beckon Earth.**_ You create a thin shroud of dust or
...
_**Beckon Fire.**_ You create a thin cloud of harmless
...
_**Beckon Water.**_ You create a spray of cool mist that
...
<!-- source_txt: srd_extract/run2/pages/p128.txt -->
<!-- source_image: srd_extract/run2/images/p128.png -->
...
_**Enlarge.**_ The target’s size increases by one category—from Medium to Large, for example. The
...
_**Reduce.**_ The target’s size decreases by one category—from Medium to Small, for example. The target also has Disadvantage on Strength checks and
Strength saving throws. The target’s attacks with
...
**Etherealness**
_Level 7 Conjuration (Bard, Cleric, Sorcerer, Warlock,_
_Wizard)_
...
_**Using a Higher-Level Spell Slot.**_ You can target up
...
<!-- source_txt: srd_extract/run2/pages/p129.txt -->
<!-- source_image: srd_extract/run2/images/p129.png -->
...
_**Asleep.**_ The target has the Unconscious condition.
It wakes up if it takes any damage or if another
creature takes an action to shake it awake.
_**Panicked.**_ The target has the Frightened condition. On each of its turns, the Frightened target
...
_**Using a Higher-Level Spell Slot.**_ You gain 5 additional Temporary Hit Points for each spell slot level
above 1.

## Page 130

<!-- source_txt: srd_extract/run2/pages/p130.txt -->
<!-- source_image: srd_extract/run2/images/p130.png -->
...
_**Telepathic Connection.**_ While your familiar is
...
the spell.
_**Combat.**_ The familiar is an ally to you and your
allies. It rolls its own Initiative and acts on its own
turn. A familiar can’t attack, but it can take other
actions as normal.
_**Disappearance of the Familiar.**_ When the familiar drops to 0 Hit Points, it disappears. It reappears
...
wearing or carrying.
_**One Familiar Only.**_ You can’t have more than one
...
_**Combat.**_ The steed is an ally to you and your allies. In combat, it shares your Initiative count, and
...
_**Disappearance of the Steed.**_ The steed disappears if it drops to 0 Hit Points or if you die. When
...
_**Using a Higher-Level Spell Slot.**_ Use the spell
slot’s level for the spell’s level in the stat block.

## Page 131

<!-- source_txt: srd_extract/run2/pages/p131.txt -->
<!-- source_image: srd_extract/run2/images/p131.png -->
...
_**Life Bond.**_ When you regain Hit Points from a level 1+
spell, the steed regains the same number of Hit Points if
you’re within 5 feet of it.

Actions

_**Otherworldly Slam.**_ _Melee Attack Roll:_ Bonus equals
your spell attack modifier, reach 5 ft. _Hit:_ 1d8 plus the
...
_Wisdom Saving Throw:_ DC equals your spell save DC,
one creature within 60 feet the steed can see. _Failure:_
The target has the Frightened condition until the end of
your next turn.

_**Fey Step (Fey Only; Recharges after a Long Rest).**_ The
steed teleports, along with its rider, to an unoccupied
space of your choice up to 60 feet away from itself.

_**Healing Touch (Celestial Only; Recharges after a Long**_
_**Rest).**_ One creature within 5 feet of the steed regains a
...
would sense the _Alarm_ or _Glyph of Warding_ spell or a
...
<!-- source_txt: srd_extract/run2/pages/p132.txt -->
<!-- source_image: srd_extract/run2/images/p132.png -->
...
half as much damage on a successful one.
_**Using a Higher-Level Spell Slot.**_ The Fire damage
...
<!-- source_txt: srd_extract/run2/pages/p133.txt -->
<!-- source_image: srd_extract/run2/images/p133.png -->
...
for the entire possible duration, the target is Petrified until the condition is ended by _Greater Restoration_ or similar magic.
...
wind (such as one created by _Gust of Wind_ ) disperses it.
_**Using a Higher-Level Spell Slot.**_ The fog’s radius
...
such as those created by the _Gate_ spell, to enter the
...
Plane, the Feywild, the Shadowfell, or the _Plane Shift_
spell.
...
another _Forbiddance_ spell. If you cast _Forbiddance_
...
<!-- source_txt: srd_extract/run2/pages/p134.txt -->
<!-- source_image: srd_extract/run2/images/p134.png -->
...
<!-- source_txt: srd_extract/run2/pages/p135.txt -->
<!-- source_image: srd_extract/run2/images/p135.png -->
...
**Geas**
_Level 5 Enchantment (Bard, Cleric, Druid, Paladin,_
_Wizard)_
...
ends.
A _Remove Curse_, _Greater Restoration_, or _Wish_ spell
ends this spell.
_**Using a Higher-Level Spell Slot.**_ If you use a level
...
the time limit of spells such as _Raise Dead_ .
...
<!-- source_txt: srd_extract/run2/pages/p136.txt -->
<!-- source_image: srd_extract/run2/images/p136.png -->
...
_**Spider Climb.**_ The insect can climb difficult surfaces,
including along ceilings, without needing to make an
ability check.

Actions

_**Multiattack.**_ The insect makes a number of attacks
equal to half this spell’s level (round down).

_**Poison Jab.**_ _Melee Attack Roll:_ Bonus equals your spell
attack modifier, reach 10 ft. _Hit:_ 1d6 + 3 plus the spell’s
level Piercing damage plus 1d4 Poison damage.

_**Web Bolt (Spider Only).**_ _Ranged Attack Roll:_ Bonus
equals your spell attack modifier, range 60 ft. _Hit:_ 1d10
...
_**Venomous Spew (Centipede Only).**_ _Constitution Saving_
_Throw:_ Your spell save DC, one creature the insect can
see within 10 feet. _Failure:_ The target has the Poisoned
...
_**Using a Higher-Level Spell Slot.**_ The barrier
...
_**Set the Trigger.**_ You decide what triggers the
...
_**Explosive Rune.**_ When triggered, the glyph erupts
...
<!-- source_txt: srd_extract/run2/pages/p137.txt -->
<!-- source_image: srd_extract/run2/images/p137.png -->

choice when you create the glyph) on a failed save
or half as much damage on a successful one.
_**Spell Glyph.**_ You can store a prepared spell of
...
slot you use for the _Glyph of Warding_ .
...
**Greater Restoration**
_Level 5 Abjuration (Bard, Cleric, Druid, Paladin,_
_Ranger)_
...
<!-- source_txt: srd_extract/run2/pages/p138.txt -->
<!-- source_image: srd_extract/run2/images/p138.png -->

The spell creates the effects below within the
warded area. _Dispel Magic_ has no effect on _Guards_
_and Wards_ itself, but each of the following effects
can be dispelled. If all four are dispelled, _Guards and_
_Wards_ ends. If you cast the spell every day for 365
days on the same area, the spell thereafter lasts until all its effects are dispelled.
_**Corridors.**_ Fog fills all the warded corridors,
...
_**Doors.**_ All doors in the warded area are magically
locked, as if sealed by the _Arcane Lock_ spell. In addition, you can cover up to ten doors with an illusion
to make them appear as plain sections of wall.
_**Stairs.**_ Webs fill all stairs in the warded area from
top to bottom, as in the _Web_ spell. These strands
...
an area already under the effect of _Hallow_ . The affected area has the following effects.
_**Hallowed Ward.**_ Choose any of these creature
...
_**Extra Effect.**_ You bind an extra effect to the area
from the list below:
...
<!-- source_txt: srd_extract/run2/pages/p139.txt -->
<!-- source_image: srd_extract/run2/images/p139.png -->
...
<!-- source_txt: srd_extract/run2/pages/p140.txt -->
<!-- source_image: srd_extract/run2/images/p140.png -->
...
_**Using a Higher-Level Spell Slot.**_ Your Concentration can last longer with a spell slot of level 2 (up to
...
**Hold Monster**
_Level 5 Enchantment (Bard, Sorcerer, Warlock,_
_Wizard)_
...
<!-- source_txt: srd_extract/run2/pages/p141.txt -->
<!-- source_image: srd_extract/run2/images/p141.png -->
...
**Hold Person**
_Level 2 Enchantment (Bard, Cleric, Druid, Sorcerer,_
_Warlock, Wizard)_
...
_**Using a Higher-Level Spell Slot.**_ Your Concentration can last longer with a spell slot of level 3–4 (up
...
Cold damage.
_**Using a Higher-Level Spell Slot.**_ The Cold damage
...
<!-- source_txt: srd_extract/run2/pages/p142.txt -->
<!-- source_image: srd_extract/run2/images/p142.png -->

_**Using a Higher-Level Spell Slot.**_ The Bludgeoning
...
A _Dispel Magic_ spell can end the spell only if it is
...
created by _Gust of Wind_ ) disperses it.
...
<!-- source_txt: srd_extract/run2/pages/p143.txt -->
<!-- source_image: srd_extract/run2/images/p143.png -->
...
**Jump**
_Level 1 Transmutation (Druid, Ranger, Sorcerer,_
_Wizard)_
...
<!-- source_txt: srd_extract/run2/pages/p144.txt -->
<!-- source_image: srd_extract/run2/images/p144.png -->
...
If the target is held shut by _Arcane Lock_, that spell
...
<!-- source_txt: srd_extract/run2/pages/p145.txt -->
<!-- source_image: srd_extract/run2/images/p145.png -->

**Locate Creature**
_Level 4 Divination (Bard, Cleric, Druid, Paladin,_
_Ranger, Wizard)_
...
If the creature you described or named is in a different form, such as under the effects of a _Flesh to_
_Stone_ or _Polymorph_ spell, this spell doesn’t locate
the creature.
...
**Locate Object**
_Level 2 Divination (Bard, Cleric, Druid, Paladin,_
_Ranger, Wizard)_
...
<!-- source_txt: srd_extract/run2/pages/p146.txt -->
<!-- source_image: srd_extract/run2/images/p146.png -->
...
by a _Protection from Evil and Good_ or _Magic Circle_
...
several.
_**Using a Higher-Level Spell Slot.**_ The spell creates
...
**Magic Weapon**
_Level 2 Transmutation (Paladin, Ranger, Sorcerer,_
_Wizard)_
...
<!-- source_txt: srd_extract/run2/pages/p147.txt -->
<!-- source_image: srd_extract/run2/images/p147.png -->
...
_**Using a Higher-Level Spell Slot.**_ The bonus increases to +2 with a level 3–5 spell slot. The bonus
...
creature.
_**Using a Higher-Level Spell Slot.**_ The spell lasts
...
<!-- source_txt: srd_extract/run2/pages/p148.txt -->
<!-- source_image: srd_extract/run2/images/p148.png -->
...
_**Using a Higher-Level Spell Slot.**_ The duration is
...
**Mending**
_Transmutation Cantrip (Bard, Cleric, Druid, Sorcerer,_
_Wizard)_
...
**Message**
_Transmutation Cantrip (Bard, Druid, Sorcerer,_
_Wizard)_
...
<!-- source_txt: srd_extract/run2/pages/p149.txt -->
<!-- source_image: srd_extract/run2/images/p149.png -->
...
no spell—not even _Wish_ —can gather information
...
_**Sound.**_ If you create a sound, its volume can range
...
the spell ends.
_**Image.**_ If you create an image of an object—such
...
<!-- source_txt: srd_extract/run2/pages/p150.txt -->
<!-- source_image: srd_extract/run2/images/p150.png -->
...
A _Remove Curse_ or _Greater Restoration_ spell cast
on the target restores the creature’s true memory.
_**Using a Higher-Level Spell Slot.**_ You can alter the
...
<!-- source_txt: srd_extract/run2/pages/p151.txt -->
<!-- source_image: srd_extract/run2/images/p151.png -->
...
creature is shape-shifted (as a result of the _Poly-_
_morph_ spell, for example), it reverts to its true form
...
<!-- source_txt: srd_extract/run2/pages/p152.txt -->
<!-- source_image: srd_extract/run2/images/p152.png -->
...
**Planar Binding**
_Level 5 Abjuration (Bard, Cleric, Druid, Warlock,_
_Wizard)_
...
<!-- source_txt: srd_extract/run2/pages/p153.txt -->
<!-- source_image: srd_extract/run2/images/p153.png -->
...
center of the inverted version of the _Magic Circle_
...
_**Using a Higher-Level Spell Slot.**_ The duration
increases with a spell slot of level 6 (10 days), 7 (30
days), 8 (180 days), and 9 (366 days).

**Plane Shift**
_Level 7 Conjuration (Cleric, Druid, Sorcerer, Warlock,_
_Wizard)_
...
_**Overgrowth.**_ Choose a point within range. All
...
from being affected.
_**Enrichment.**_ All plants in a half-mile radius centered on a point within range become enriched for
365 days. The plants yield twice the normal amount
of food when harvested. They can benefit from only
one _Plant Growth_ per year.

**Poison Spray**
_Necromancy Cantrip (Druid, Sorcerer, Warlock,_
_Wizard)_
...
_**Cantrip Upgrade.**_ The damage increases by 1d12
...
<!-- source_txt: srd_extract/run2/pages/p154.txt -->
<!-- source_image: srd_extract/run2/images/p154.png -->
...
**Power Word Kill**
_Level 9 Enchantment (Bard, Sorcerer, Warlock,_
_Wizard)_
...
**Prestidigitation**
_Transmutation Cantrip (Bard, Sorcerer, Warlock,_
_Wizard)_
...
_**Sensory Effect.**_ You create an instantaneous,
harmless sensory effect, such as a shower of sparks,
a puff of wind, faint musical notes, or an odd odor.
_**Fire Play.**_ You instantaneously light or snuff out a
candle, a torch, or a small campfire.
_**Clean or Soil.**_ You instantaneously clean or soil an
object no larger than 1 cubic foot.
_**Minor Sensation.**_ You chill, warm, or flavor up to
1 cubic foot of nonliving material for 1 hour.
_**Magic Mark.**_ You make a color, a small mark, or a
symbol appear on an object or a surface for 1 hour.
_**Minor Creation.**_ You create a nonmagical trinket
...
<!-- source_txt: srd_extract/run2/pages/p155.txt -->
<!-- source_image: srd_extract/run2/images/p155.png -->
...
gone for the duration. _Antimagic Field_ has no effect
on the wall, and _Dispel Magic_ can affect only the violet layer.
...
| 2 | Orange. Failed Save: 12d6 Acid damage. Successful Save: Half as much damage. Additional Effects: Magical ranged attacks can’t pass through this layer, which is destroyed by a strong wind (such as the one created by _Gust of Wind_). |
...
| 4 | Green. Failed Save: 12d6 Poison damage. Successful Save: Half as much damage. Additional Effects: A _Passwall_ spell, or another spell of equal or greater level that can open a portal on a solid surface, destroys this layer. |
...
| 6 | Indigo. Failed Save: The target has the Restrained condition and makes a Constitution saving throw at the end of each of its turns. If it successfully saves three times, the condition ends. If it fails three times, it has the Petrified condition until it is freed by an effect like the _Greater Restoration_ spell. The successes and failures needn’t be consecutive; keep track of both until the target collects three of a kind. Additional Effects: Spells can’t be cast through this layer, which is destroyed by Bright Light shed by the _Daylight_ spell. |
| 7 | Violet. Failed Save: The target has the Blinded condition and makes a Wisdom saving throw at the start of your next turn. On a successful save, the condition ends. On a failed save, the condition ends, and the creature teleports to another plane of existence (GM’s choice). Additional Effects: This layer is destroyed by _Dispel Magic_. |

## Page 156

<!-- source_txt: srd_extract/run2/pages/p156.txt -->
<!-- source_image: srd_extract/run2/images/p156.png -->
...
_**Using a Higher-Level Spell Slot.**_ You can increase
...
_**Cantrip Upgrade.**_ The damage increases by 1d8
...
<!-- source_txt: srd_extract/run2/pages/p157.txt -->
<!-- source_image: srd_extract/run2/images/p157.png -->

image, and any noise it makes sounds hollow to the
creature.

**Protection from Energy**
_Level 3 Abjuration (Cleric, Druid, Ranger, Sorcerer,_
_Wizard)_
...
_Level 1 Abjuration (Cleric, Druid, Paladin, Warlock,_
_Wizard)_
...
<!-- source_txt: srd_extract/run2/pages/p158.txt -->
<!-- source_image: srd_extract/run2/images/p158.png -->
...
A _Disintegrate_ spell targeting the globe destroys it
...
<!-- source_txt: srd_extract/run2/pages/p159.txt -->
<!-- source_image: srd_extract/run2/images/p159.png -->
...
2d6 Fire damage.
_**Using a Higher-Level Spell Slot.**_ You create one
additional ray for each spell slot level above 2.

## Page 160

<!-- source_txt: srd_extract/run2/pages/p160.txt -->
<!-- source_image: srd_extract/run2/images/p160.png -->

**Scrying**
_Level 5 Divination (Bard, Cleric, Druid, Warlock,_
_Wizard)_
...
save, the spell ends.
_**Using a Higher-Level Spell Slot.**_ All the damage
increases by 1d6 for each spell slot level above 1.
...
<!-- source_txt: srd_extract/run2/pages/p161.txt -->
<!-- source_image: srd_extract/run2/images/p161.png -->
...
hit by an attack roll or targeted by the _Magic Missile_
spell
**Range:** Self
**Components:** V, S
**Duration:** 1 round
...
<!-- source_txt: srd_extract/run2/pages/p162.txt -->
<!-- source_image: srd_extract/run2/images/p162.png -->
...
go of the weapon.
_**Cantrip Upgrade.**_ The damage die changes when
...
<!-- source_txt: srd_extract/run2/pages/p163.txt -->
<!-- source_image: srd_extract/run2/images/p163.png -->
...
_**Cantrip Upgrade.**_ The range doubles when you
reach levels 5 (30 feet), 11 (60 feet), and 17 (120
feet).

## Page 164

<!-- source_txt: srd_extract/run2/pages/p164.txt -->
<!-- source_image: srd_extract/run2/images/p164.png -->
...
<!-- source_txt: srd_extract/run2/pages/p165.txt -->
<!-- source_image: srd_extract/run2/images/p165.png -->
...
the one created by _Gust of Wind_ ) disperses it.
...
**Stoneskin**
_Level 4 Transmutation (Druid, Ranger, Sorcerer,_
_Wizard)_
...
_**Turn 2.**_ Acidic rain falls. Each creature and object
under the cloud takes 4d6 Acid damage.
_**Turn 3.**_ You call six bolts of lightning from the
...
<!-- source_txt: srd_extract/run2/pages/p166.txt -->
<!-- source_image: srd_extract/run2/images/p166.png -->

_**Turn 4.**_ Hailstones rain down. Each creature under the cloud takes 2d6 Bludgeoning damage.
_**Turns 5–10.**_ Gusts and freezing rain assail the
...
**Suggestion**
_Level 2 Enchantment (Bard, Sorcerer, Warlock,_
_Wizard)_
...
| Ability | Mod | Save | Ability | Mod | Save | Ability | Mod | Save |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
_**Shared Resistances.**_ When you summon the spirit,
choose one of its Resistances. You have Resistance to
the chosen damage type until the spell ends.

Actions

_**Multiattack.**_ The spirit makes a number of Rend attacks
equal to half the spell’s level (round down), and it uses
Breath Weapon.

_**Rend.**_ _Melee Attack Roll:_ Bonus equals your spell attack
modifier, reach 10 feet. _Hit:_ 1d6 + 4 + the spell’s level
Piercing damage.

_**Breath Weapon.**_ _Dexterity Saving Throw:_ DC equals
your spell save DC, each creature in a 30-foot Cone.
_Failure:_ 2d6 damage of a type this spirit has Resistance
to (your choice when you cast the spell). _Success:_
Half damage.
...
<!-- source_txt: srd_extract/run2/pages/p167.txt -->
<!-- source_image: srd_extract/run2/images/p167.png -->
...
_**Death.**_ Each target makes a Constitution saving
throw, taking 10d10 Necrotic damage on a failed
save or half as much damage on a successful save.
_**Discord.**_ Each target makes a Wisdom saving
...
_**Fear.**_ Each target must succeed on a Wisdom
...
turns, if able.
_**Pain.**_ Each target must succeed on a Constitution
saving throw or have the Incapacitated condition
for 1 minute.
_**Sleep.**_ Each target must succeed on a Wisdom saving throw or have the Unconscious condition for 10
minutes. A creature awakens if it takes damage or if
someone takes an action to shake it awake.
_**Stunning.**_ Each target must succeed on a Wisdom
...
_**Creature.**_ You can try to move a Huge or smaller
...
_**Object.**_ You can try to move a Huge or smaller
...
<!-- source_txt: srd_extract/run2/pages/p168.txt -->
<!-- source_image: srd_extract/run2/images/p168.png -->
...
_**Familiarity.**_ Here are the meanings of the terms
...
_**Mishap.**_ The spell’s unpredictable magic results in
...
_**Similar Area.**_ You and your group (or the target
...
_**Off Target.**_ You and your group (or the target object) appear 2d12 miles away from the destination
...
<!-- source_txt: srd_extract/run2/pages/p169.txt -->
<!-- source_image: srd_extract/run2/images/p169.png -->
...
_**Altered Eyes.**_ You alter the appearance of your
eyes for 1 minute.
_**Booming Voice.**_ Your voice booms up to three
times as loud as normal for 1 minute. For the duration, you have Advantage on Charisma (Intimidation) checks.
_**Fire Play.**_ You cause flames to flicker, brighten,
...
_**Phantom Sound.**_ You create an instantaneous
...
_**Tremors.**_ You cause harmless tremors in the
ground for 1 minute.
...
**Tongues**
_Level 3 Divination (Bard, Cleric, Sorcerer, Warlock,_
_Wizard)_
...
<!-- source_txt: srd_extract/run2/pages/p170.txt -->
<!-- source_image: srd_extract/run2/images/p170.png -->
...
_**Creature into Creature.**_ If you turn a creature
...
creature can’t use or otherwise benefit from any of
that equipment.
_**Object into Creature.**_ You can turn an object into
...
_**Creature into Object.**_ If you turn a creature into
...
<!-- source_txt: srd_extract/run2/pages/p171.txt -->
<!-- source_image: srd_extract/run2/images/p171.png -->

creature’s name. The creature then appears in an
unoccupied space you choose within 10 feet of you.

**True Seeing**
_Level 6 Divination (Bard, Cleric, Sorcerer, Warlock,_
_Wizard)_
...
(your choice).
_**Cantrip Upgrade.**_ Whether you deal Radiant damage or the weapon’s normal damage type, the attack
...
<!-- source_txt: srd_extract/run2/pages/p172.txt -->
<!-- source_image: srd_extract/run2/images/p172.png -->
...
damage only.
_**Using a Higher-Level Spell Slot.**_ The initial damage increases by 2d4 for each spell slot level above
4.
...
_Dispel Magic._ A _Disintegrate_ spell destroys the wall
...
<!-- source_txt: srd_extract/run2/pages/p173.txt -->
<!-- source_image: srd_extract/run2/images/p173.png -->

_**Using a Higher-Level Spell Slot.**_ The damage the
...
makes this save only once per turn.
_**Using a Higher-Level Spell Slot.**_ Both types of
...
**Water Breathing**
_Level 3 Transmutation (Druid, Ranger, Sorcerer,_
_Wizard)_
...
<!-- source_txt: srd_extract/run2/pages/p174.txt -->
<!-- source_image: srd_extract/run2/images/p174.png -->
...
<!-- source_txt: srd_extract/run2/pages/p175.txt -->
<!-- source_image: srd_extract/run2/images/p175.png -->
...
_Wish_ is the mightiest spell a mortal can cast. By
...
the _Greater Restoration_ spell.
...
accommodate the new result. For example, a _Wish_
...
The stress of casting _Wish_ to produce any effect
...
_Wish_ ever again if you suffer this stress.
