...
<!-- source_txt: srd_extract/run2/pages/p001.txt -->
<!-- source_image: srd_extract/run2/images/p001.png -->
...
(“CC-BY-4.0”). You are free to use the content in this document in any manner permitted under CC-BY-4.0, provided that you include the following attribution statement in any of your work:
...
<!-- source_txt: srd_extract/run2/pages/p003.txt -->
<!-- source_image: srd_extract/run2/images/p003.png -->
...
**3** System Reference Document 5.2.1
...
<!-- source_txt: srd_extract/run2/pages/p004.txt -->
<!-- source_image: srd_extract/run2/images/p004.png -->
...
**4** System Reference Document 5.2.1
