...
<!-- source_txt: srd_extract/run2/pages/p019.txt -->
<!-- source_image: srd_extract/run2/images/p019.png -->
...
_**Write Your XP.**_ Also record your Experience
Points. A level 1 character has 0 XP.
_**Starting at a Higher Level.**_ Your GM might start
...
<!-- source_txt: srd_extract/run2/pages/p020.txt -->
<!-- source_image: srd_extract/run2/images/p020.png -->
...
_**Record Your Feat.**_ A background gives you a feat,
which grants your character particular capabilities.
Feats are detailed in “Feats.” Write the feat on your
character sheet.
_**Note Proficiencies.**_ Your background gives proficiency in two skills and with one tool. Record this
...
<!-- source_txt: srd_extract/run2/pages/p021.txt -->
<!-- source_image: srd_extract/run2/images/p021.png -->
...
_**Point Cost.**_ You have 27 points to spend on your
...
_**Lawful Good (LG).**_ Lawful Good creatures endeavor to do the right thing as expected by society.
Someone who fights injustice and protects the innocent without hesitation is probably Lawful Good.
_**Neutral Good (NG).**_ Neutral Good creatures do the
...
_**Chaotic Good (CG).**_ Chaotic Good creatures act as
...
_**Lawful Neutral (LN).**_ Lawful Neutral individuals
...
_**Neutral (N).**_ Neutral is the alignment of those who
prefer to avoid moral questions and don’t take sides,

## Page 22

<!-- source_txt: srd_extract/run2/pages/p022.txt -->
<!-- source_image: srd_extract/run2/images/p022.png -->
...
_**Chaotic Neutral (CN).**_ Chaotic Neutral creatures
...
_**Lawful Evil (LE).**_ Lawful Evil creatures methodically take what they want within the limits of a code
of tradition, loyalty, or order. An aristocrat exploiting citizens while scheming for power is probably
Lawful Evil.
_**Neutral Evil (NE).**_ Neutral Evil is the alignment of
...
_**Chaotic Evil (CE).**_ Chaotic Evil creatures act
...
_**Saving Throws.**_ For the saving throws you have
...
_**Skills.**_ For skills you have proficiency in, add your
...
_**Passive Perception.**_ Sometimes your GM will determine whether your character notices something
...
_**Hit Points.**_ Your class and Constitution modifier
...
_**Hit Point Dice.**_ Your class’s description tells you
...
_**Initiative.**_ Write your Dexterity modifier in the
space for Initiative on your character sheet.
_**Armor Class.**_ Without armor or a shield, your
...
_**Attacks.**_ In the Weapons & Damage Cantrips
...
_**Spellcasting.**_ Note both the saving throw DC for
your spells and the attack bonus for attacks you
make with them, using these formulas:

## Page 23

<!-- source_txt: srd_extract/run2/pages/p023.txt -->
<!-- source_image: srd_extract/run2/images/p023.png -->
...
<!-- source_txt: srd_extract/run2/pages/p024.txt -->
<!-- source_image: srd_extract/run2/images/p024.png -->
...
Spellcasters gain iconic spells such as _Fireball_, _Lightning Bolt_, and _Raise Dead_. Most weapon-focused
...
<!-- source_txt: srd_extract/run2/pages/p025.txt -->
<!-- source_image: srd_extract/run2/images/p025.png -->
...
_**Spells Prepared.**_ You determine what spells you
...
_**Cantrips.**_ If a cantrip of yours increases in power
...
_**Spell Slots.**_ You determine your available spell
...
lower-level spell that you cast, like _Burning Hands_,
...
<!-- source_txt: srd_extract/run2/pages/p026.txt -->
<!-- source_image: srd_extract/run2/images/p026.png -->
...
their effects.
_**Pact Magic.**_ If you have the Pact Magic feature
...
<!-- source_txt: srd_extract/run2/pages/p027.txt -->
<!-- source_image: srd_extract/run2/images/p027.png -->
...
| 82 | Half a floor plan for a temple, a castle, or another<br>structure |
...
| 86 | An empty silver snuffbox bearing the inscription<br>“dreams” on its lid |
