...
<!-- source_txt: srd_extract/run2/pages/p005.txt -->
<!-- source_image: srd_extract/run2/images/p005.png -->
...
**ers’ Actions.** Sometimes resolving a task is easy.
...
_**Round Down**_ Whenever you divide or multiply a
number in the game, round down if you end up with
a fraction, even if the fraction is one-half or greater.
Some rules make an exception and tell you to round
up.
...
**4: Roll 1d20.** You always want to roll high. If the
...
- **The Relevant Ability Modifier.** “Playing the
Game” and “Rules Glossary” explain which ability
modifiers to use for various D20 Tests.

- **Your Proficiency Bonus If Relevant.** Each creature has a Proficiency Bonus, a number added
when making a D20 Test that uses something,
such as a skill, in which the creature has proficiency. See “Proficiency” later in “Playing the
Game.”
...
**6: Compare the Total to a Target Number.** If the
total of the d20 and its modifiers equals or exceeds the target number, the D20 Test succeeds.
...
ability check or a saving throw is called a Difficulty Class (DC). The target number for an attack
...
forcing open a stuck door, picking a lock, entertaining a crowd, or deciphering a cipher. The GM and the
...
uncertain and narratively interesting, the dice determine the result.

**Ability Modifier**
An ability check is named for the ability modifier it
uses: a Strength check, an Intelligence check, and so
on. Different ability checks are called for in different situations, depending on which ability is most
...
when the GM determines that a skill or tool proficiency is relevant to the check and you have
...
checks, but the GM ultimately sets them. The Typical Difficulty Classes table presents a range of possible DCs for ability checks.
...
<!-- source_txt: srd_extract/run2/pages/p007.txt -->
<!-- source_image: srd_extract/run2/images/p007.png -->
...
**7** System Reference Document 5.2.1
...
_**Calculating AC.**_ All creatures start with the same
base AC calculation:
...
_**Only One Base AC.**_ Some spells and class features
...
Disadvantage. Advantage reflects the positive circumstances surrounding a d20 roll, while Disadvantage reflects negative circumstances.
You usually acquire Advantage or Disadvantage
through the use of special abilities and actions. The

## Page 8

<!-- source_txt: srd_extract/run2/pages/p008.txt -->
<!-- source_image: srd_extract/run2/images/p008.png -->
...
_**Only One at a Time.**_ You can never have more
...
who lacks it.
_**Gaining Heroic Inspiration.**_ Your GM can
...
<!-- source_txt: srd_extract/run2/pages/p009.txt -->
<!-- source_image: srd_extract/run2/images/p009.png -->
...
**9** System Reference Document 5.2.1
...
<!-- source_txt: srd_extract/run2/pages/p010.txt -->
<!-- source_image: srd_extract/run2/images/p010.png -->
...
**10** System Reference Document 5.2.1
...
Certain special abilities, spells, and situations allow you to take a special action called a Reaction. A
...
<!-- source_txt: srd_extract/run2/pages/p011.txt -->
<!-- source_image: srd_extract/run2/images/p011.png -->
...
**11** System Reference Document 5.2.1
...
_**Dim Light.**_ Dim Light, also called shadows, creates a Lightly Obscured area. An area of Dim Light
...
_**Darkness.**_ Darkness creates a Heavily Obscured
...
ambush. The Game Master decides when circumstances are appropriate for hiding. When you try to
...
<!-- source_txt: srd_extract/run2/pages/p012.txt -->
<!-- source_image: srd_extract/run2/images/p012.png -->
...
**12** System Reference Document 5.2.1
...
<!-- source_txt: srd_extract/run2/pages/p013.txt -->
<!-- source_image: srd_extract/run2/images/p013.png -->
...
_**Surprise.**_ If a combatant is surprised by combat
...
_**Initiative Order.**_ A combatant’s check total is
...
_**Communicating.**_ You can communicate however
...
_**Interacting with Things.**_ You can interact with
...
_**Speed.**_ Rather than moving foot by foot, move
...
character sheet.
_**Entering a Square.**_ To enter a square, you must
...
_**Corners.**_ Diagonal movement can’t cross the corner of a wall, a large tree, or another terrain feature
that fills its space.
_**Ranges.**_ To determine the range on a grid between two things—whether creatures or objects—
...
<!-- source_txt: srd_extract/run2/pages/p014.txt -->
<!-- source_image: srd_extract/run2/images/p014.png -->
...
drawbridge.
_**Doing Nothing on Your Turn.**_ You can forgo moving, taking an action, or doing anything at all on
...
**14** System Reference Document 5.2.1
...
<!-- source_txt: srd_extract/run2/pages/p015.txt -->
<!-- source_image: srd_extract/run2/images/p015.png -->
...
_**Avoiding Opportunity Attacks.**_ You can avoid
...
_**Making an Opportunity Attack.**_ You can make an
...
**15** System Reference Document 5.2.1

## Page 16

<!-- source_txt: srd_extract/run2/pages/p016.txt -->
<!-- source_image: srd_extract/run2/images/p016.png -->
...
Hit Points. Hit Point loss has no effect on your capabilities until you reach 0 Hit Points.
...
the same time, roll the damage once for all the targets. For example, when a wizard casts _Fireball_, the
...
<!-- source_txt: srd_extract/run2/pages/p017.txt -->
<!-- source_image: srd_extract/run2/images/p017.png -->

Glossary” and have no rules of their own, but other
rules, such as Resistance, rely on damage types.
...
instance. For example, if you have Resistance to Necrotic damage as well as Resistance to all damage,
...
For example, a creature has Resistance to all damage and Vulnerability to Fire damage, and it’s within
a magical aura that reduces all damage by 5. If it
takes 28 Fire damage, the damage is first reduced
by 5 (to 23), then halved for the creature’s Resistance (and rounded down to 11), then doubled for
its Vulnerability (to 22).
#### **Immunity**

Some creatures and objects have Immunity to certain damage types and conditions. Immunity to a
...
_Cure Wounds_ spell or a _Potion of Healing_, or by a
Short or Long Rest (see “Rules Glossary”).

#### **Knocking Out a Creature**

When you would reduce a creature to 0 Hit Points
with a melee attack, you can instead reduce the creature to 1 Hit Point and give it the Unconscious condition. It then starts a Short Rest, at the end of which
...
**17** System Reference Document 5.2.1
...
_**Monster Death.**_ A monster dies the instant it
drops to 0 Hit Points, although a Game Master can
ignore this rule for an individual monster and treat
it like a character.
_**Hit Point Maximum of 0.**_ A creature dies if its Hit
Point maximum reaches 0. Certain effects drain life
energy, reducing a creature’s Hit Point maximum.
_**Massive Damage.**_ When damage reduces a character to 0 Hit Points and damage remains, the character dies if the remainder equals or exceeds their
...
way to revive your character, such as with the _Raise_
_Dead_ spell. Or talk with the GM about making a new
...
_**Three Successes/Failures.**_ Roll 1d20. If the roll
...
<!-- source_txt: srd_extract/run2/pages/p018.txt -->
<!-- source_image: srd_extract/run2/images/p018.png -->

_**Rolling a 1 or 20.**_ When you roll a 1 on the d20
for a Death Saving Throw, you suffer two failures. If
you roll a 20 on the d20, you regain 1 Hit Point.
_**Damage at 0 Hit Points.**_ If you take any damage
...
**18** System Reference Document 5.2.1
