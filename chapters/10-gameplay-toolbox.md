...
<!-- source_txt: srd_extract/run2/pages/p192.txt -->
<!-- source_image: srd_extract/run2/images/p192.png -->
...
time, as with a spell such as _Wind Walk_ or a magic
item such as a _Carpet of Flying_, translate the party’s
...
<!-- source_txt: srd_extract/run2/pages/p193.txt -->
<!-- source_image: srd_extract/run2/images/p193.png -->
...
**Bestow Curse**
The simplest curses are created by the _Bestow Curse_
spell. The effects of such curses are limited and can
be ended by the _Remove Curse_ spell.
_Bestow Curse_ provides useful benchmarks for
...
You decide how a spell like _Remove Curse_ affects
...
casting _Remove Curse_ on its corpse.
...
like _Remove Curse_ affects a curse that’s part of your
...
_**Demonic Possession.**_ Demonic Possession arises
...
creature. A _Dispel Evil and Good_ spell or any magic
that removes a curse also ends the effect on it.

## Page 194

<!-- source_txt: srd_extract/run2/pages/p194.txt -->
<!-- source_image: srd_extract/run2/images/p194.png -->
...
_**Spreading the Contagion.**_ Any Humanoid (other
...
_**Fighting the Contagion.**_ Daily at dawn, an infected creature makes a DC 11 Constitution saving
...
contagion ends.
_**Fighting the Contagion.**_ Magic such as a _Heal_ or
_Lesser Restoration_ spell ends the contagion immediately. A character who is proficient with an Herbalism Kit can use it to create one dose of nonmagical
...
the creature.
_**Spreading the Contagion.**_ Any Humanoid that
...
<!-- source_txt: srd_extract/run2/pages/p195.txt -->
<!-- source_image: srd_extract/run2/images/p195.png -->
...
<!-- source_txt: srd_extract/run2/pages/p196.txt -->
<!-- source_image: srd_extract/run2/images/p196.png -->
...
_**Short-Term Effects.**_ The character has the Frightened, Incapacitated, or Stunned condition for 1d10
minutes. This condition might be accompanied by
alarming behavior or hallucinations. These effects
can be suppressed with the _Calm Emotions_ spell or
removed by the _Lesser Restoration_ spell.
_**Long-Term Effects.**_ The character has Disadvantage on some or all ability checks for 1d10 × 10
...
These effects can be suppressed with the _Calm_
_Emotions_ spell or removed by the _Lesser Restoration_
spell.
_**Indefinite Effects.**_ An indefinite effect is a long-term effect (see above) that lasts until removed by a
_Greater Restoration_ spell. It can be suppressed by a
_Calm Emotions_ spell.

## Page 197

<!-- source_txt: srd_extract/run2/pages/p197.txt -->
<!-- source_image: srd_extract/run2/images/p197.png -->
...
<!-- source_txt: srd_extract/run2/pages/p198.txt -->
<!-- source_image: srd_extract/run2/images/p198.png -->
...
<!-- source_txt: srd_extract/run2/pages/p199.txt -->
<!-- source_image: srd_extract/run2/images/p199.png -->
...
_**Detect and Disarm.**_ As a Search action, a creature
...
_**At Higher Levels.**_ You can scale the trap for higher
...
_**Destroy the Net.**_ Reducing the Net to 0 Hit Points
frees any creature trapped in it (see “Adventuring
Gear” for the Net’s statistics).
_**Set the Trap.**_ A creature that has Thieves’ Tools
...
<!-- source_txt: srd_extract/run2/pages/p200.txt -->
<!-- source_image: srd_extract/run2/images/p200.png -->
...
_**Detect and Disarm.**_ A _Detect Magic_ spell reveals
...
_**Detect and Disarm.**_ As a Study action, a creature
...
be held shut using _Arcane Lock_ or similar magic.
...
_**Escape.**_ A creature needs a Climb Speed, climbing
gear, or magic such as _Spider Climb_ to scale the pit’s
...
<!-- source_txt: srd_extract/run2/pages/p201.txt -->
<!-- source_image: srd_extract/run2/images/p201.png -->

condition for 1 hour. On a successful save, the creature takes half as much damage only.
_**Avoid.**_ The trap doesn’t trigger if the lock is
opened using a _Knock_ spell or similar magic.
_**Detect and Disarm.**_ As a Search action, a creature
...
**Rolling Stone**
_Deadly Trap (Levels 11–16) or Nuisance Trap (Levels_
_17–20)_
...
_**Destroy the Stone.**_ The stone is a Large object
that has AC 17, HP 100, a Damage Threshold of 10,
and Immunity to Poison and Psychic damage.
_**Slow the Stone.**_ As an action, a creature can try to
...
surrounding floor to prevent the lid from opening,
thereby making it safe to cross. The cover can also
be held shut using an _Arcane Lock_ spell or similar
magic.
_**Escape.**_ A creature needs a Climb Speed, climbing
gear, or magic such as a _Spider Climb_ spell to scale
...
<!-- source_txt: srd_extract/run2/pages/p202.txt -->
<!-- source_image: srd_extract/run2/images/p202.png -->
...
<!-- source_txt: srd_extract/run2/pages/p203.txt -->
<!-- source_image: srd_extract/run2/images/p203.png -->
